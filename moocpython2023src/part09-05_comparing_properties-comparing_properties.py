...
class RealProperty:
    ...
    def price_difference(self, compare_to:"RealProperty")->int:
        ...
        compare_to_total_price = compare_to.square_metres*compare_to.price_per_sqm
        return abs(self_total_price - compare_to_total_price)

    def more_expensive(self, compare_to:"RealProperty")->bool:
        self_total_price = self.square_metres*self.price_per_sqm
        compare_to_total_price = compare_to.square_metres*compare_to.price_per_sqm
        return self_total_price > compare_to_total_price
